...
# Alpine / Wget:
#
#   wget -O- https://raw.githubusercontent.com/nholuongut/nagios-plugins/master/setup/bootstrap.sh | sh
#
# Curl:
#
#   curl https://raw.githubusercontent.com/nholuongut/nagios-plugins/master/setup/bootstrap.sh | sh

set -eu
[ -n "${DEBUG:-}" ] && set -x
srcdir="$(dirname "$0")"

repo="nholuongut/nagios-pnholuongut/nagios-plugins
