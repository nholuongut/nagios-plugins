...
export DOCKER_IMAGE="nholuongut/nagios-plugins"
export DOCKER_IMAGE_TAGS="latest centos debian ubuntu alpine"
export DOCKER_IMAGES=(harisekhon/tools harisekhon/pytools nholuongut/nagios-plugins)
if is_CI; then
    # want splitting
...
if is_docker_available; then
    ...
    if is_CI; then
        ...
        trap '
            docker_rmi_grep nholuongut/nagios-plugins || :
