...
run_fail "0 2" ./check_travis_ci_last_build.py -r nholuongut/nagios-plugins

echo "check warning threshold to induce failure as builds should always take longer than 10 secs:"
run_fail "1 2" ./check_travis_ci_last_build.py -r nholuongut/nagios-plugins -v -w 10

echo "check critical threshold to induce failure as builds should always take longer than 10 secs:"
run_fail 2 ./check_travis_ci_last_build.py -r nholuongut/nagios-plugins -v -c 10
...
#run_fail 3 ./check_travis_ci_last_build.py -r nholuongut/nagios-plugins -v
